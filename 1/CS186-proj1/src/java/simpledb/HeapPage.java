...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        ...
        int numsTuples = BufferPool.PAGE_SIZE*8/(td.getSize()*8+1);
        return numsTuples;
    }
    ...
    public boolean isSlotUsed(int i) {
        // some code goes here
        //这里我们根据给定i编号去查首部header来判断当前凹槽是否可用
        int indexOfHeader = i/8;
        int pos = i%8;
        return (header[indexOfHeader]>>pos&1)==1;
    }
    ...
    public class UsedTupleIterator implements Iterator<Tuple>{
        ...
        public boolean hasNext() {
            int idx = pos+1;
            while(idx<getNumTuples()&&tuples[idx]==null) {
                idx++;
            }
            return idx!=getNumTuples();
        }
