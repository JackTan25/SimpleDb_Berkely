...
public class StringAggregatorTest extends SimpleDbTestBase {
  ...
  public TupleDesc getTupleDesc(int gbIndex,int agIndex,TupleDesc td){
    ...
    if(gbIndex==Aggregator.NO_GROUPING){
      ...
      types = new Type[]{td.getFieldType(gbIndex),Type.INT_TYPE};
  ...
  @Test public void mergeCount() throws Exception {
    scan1.open();
    StringAggregator agg = new StringAggregator(0, Type.INT_TYPE, 1, Aggregator.Op.COUNT,getTupleDesc(0,1,scan1.getTupleDesc()));
